...
| **NFC card PVC bianca** | Tessera rigida bianca liscia, la scrivi tu con NFC Tools | **Card funzionale**: la lasci allo staff o la usi come scorta. Fa il suo lavoro ma comunica "gadget economico" | ⚠️ Solo dietro le quinte |
| **NFC card custom / nera / metallo** | Tessera stampata full-color col brand trovatemi.it, oppure nera/metallo premium | La **card-eroe che porti TU in demo**. Un solo oggetto, riusabile all'infinito. Comunica "agenzia seria" | ✅ Sì — è il WOW |
...
> ⚠️ **Due chiarimenti che evitano acquisti sbagliati:**
> 1. I **rotoli NON sono il prodotto di vendita** — sono la scorta da nascondere dietro card e stand.
> 2. La **PVC bianca liscia NON è la card da demo.** Davanti al titolare comunica "gadget da 20 centesimi". Per la card che porti tu, prendi una **custom stampata trovatemi.it** (o una **nera/metallo**). Le bianche restano materiale funzionale da lasciare/dare allo staff.

> 💡 **Ti brandizzi una volta sola.** Il design trovatemi.it è **generico** (punta a un tuo review link demo): stampi un piccolo lotto di card premium e **quelle usi per sempre** in ogni pitch. Non stampi niente per il singolo prospect in fase di vendita — la personalizzazione col link del cliente arriva **dopo la firma**, in onboarding, e lì basta scrivere lo sticker con NFC Tools.
...
|----------|----------|------|-------|
| **NFC card custom trovatemi.it** (o nere/metallo) — la card-eroe da demo | 5-10 pz | Vistaprint / venditori NFC custom | ~€30-50 (lotto piccolo) |
| **NFC card PVC bianche NTAG215** (funzionali / da lasciare allo staff) | 10 pz | Amazon | ~€15-25 |
...
**Totale materiale fisico Fase 0: ~€70-110.** La card premium è una tantum e ti dura per sempre; il resto sono consumabili. Con questo fai demo illimitate e attivi i primi 2-3 clienti.
...
1. **5-10 NFC card custom trovatemi.it** (o nere/metallo) — la card-eroe da demo → ~€30-50 una tantum
2. **10 NFC card PVC bianche NTAG215** (funzionali/scorta) → ~€20
3. **1 rotolo da 50 sticker NFC NTAG215** → ~€15
4. **3 espositori acrilici A6** (per gli stand fai-da-te) → ~€12
5. **App NFC Tools** → gratis
6. **Ricarica Balance Climbo a $20**
7. *(verifica di avere)* dominio `trovatemi.it` + Climbo €99/mese

**Investimento iniziale reale per iniziare a vendere: ~€70-100 di materiale** (di cui €30-50 una tantum per la card premium che dura per sempre), oltre ai €99/mese di Climbo. Tutto il resto (Fatture in Cloud, coaster, warmup email, ordine bulk) arriva dopo, in ordine di quando serve davvero.
